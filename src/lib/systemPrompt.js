...
- createThenRetrive(query) -> Creates PDF vectors and then retrieves similar chunks based on query

always first run retrieveSimilar. if context is empty or similar chunks not found then run createThenRetrive ans according to user query.
